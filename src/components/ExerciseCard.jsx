...
export default function ExerciseCard({exercise,i}) {
  ...
  return (
    ...
    bg-slate-950 sm:flex-wrap'>
        ...
        sm:item-center sm:flex-wrap gap-x-4'>
            ...
            sm:text-xl md:text-2xl flex-1 md:text-center'>
        ...
        gap-2'>
            {['reps', 'rest', 'tempo'].map(info => {
                return (
                    <div key={info} className='flex flex-col p-2 rounded 
                    border-[1.5px] border-solid border-slate-900 w-full'>
